...
- **Which AI Model did you use?** _(e.g., GPT-4o, Claude 4.5 Sonnet)_:
- **Which Platform/Tool?** _(e.g., Cursor, OpenCode, Codex, Claude Code, GitHub Copilot, standard web chat)_:
