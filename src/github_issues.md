...
- **Difficulty**: Hard 🔴
- **Description**: Finding close approaches is hard because objects travel on invisible orbits. Rendering a faint, dotted orbital path for the *currently selected* asteroid or debris particle will help users visualize why a close approach is occurring.
