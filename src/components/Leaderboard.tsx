  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        <div className="kv-row" style={{ padding: "8px", background: "rgba(56, 189, 248, 0.1)", borderRadius: "4px", display: "flex", justifyContent: "space-between" }}>
        ...
        <div className="kv-row" style={{ padding: "8px", display: "flex", justifyContent: "space-between" }}>
